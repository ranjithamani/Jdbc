...
public class FlowerTester6 {
	...
	public static void main(String[] args) {
		...
		try (Connection connection = DriverManager.getConnection(url, username, password);){
			...
			String query = "insert into  flower_table (f_name,f_price,f_color,f_fragrance,f_noOfPetals,f_pedicilate,f_type,s_trimerous,f_hypogynous)values('Lavender',1000,'Purple','lavender',250,true,'custom',true,true)";
